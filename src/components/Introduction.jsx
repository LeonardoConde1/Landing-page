  ...
  return (
    <div className='w-full bg-white py-16 px-4 h24'>
        ...
        <div className='flex flex-col justify-center max-w-[1240px] mx-auto'>
            ...
            <p>oreme ipsum dolor sit amet, consectetur adipiscing elit. 
             ...
             Donec lectus metus, laorsdfsdfsfdeet convallis finibus at, venenatis nec dolor. Donec ac finibus nisl, quis aliquet erat. Proin dictum sem nisi,Donec lorem nibh, 
